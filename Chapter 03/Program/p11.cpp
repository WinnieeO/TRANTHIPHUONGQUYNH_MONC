// Program 3.11
// This program tracks the inventory of three widget stores that opened at the same time. 
// Each store started with the same number of widgets in inventory.
// By subtracting the number of widgets each store has sold from its inventory, the current inventory can be calculated.
#include <iostream>
using namespace std;
